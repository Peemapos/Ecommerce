...
function itemList () {
    ...
    return (
        <div className="p-10 font-mono" >
            ...
            <ul className="mt-10 ">
                <li className="flex items-center gap-5 border-solid border-2 border-black p-2 rounded-md">
                ...
                <li className="mt-10 flex items-center gap-5 border-solid border-2 border-black p-2 rounded-md">
